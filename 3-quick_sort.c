...
/**
 * swap - function swaps two elements in an array
...
/**
 * partition - function partitions an array using the Lomuto scheme
...
/**
 * quick_sort_rec - function sorts an array of integers in ascending
